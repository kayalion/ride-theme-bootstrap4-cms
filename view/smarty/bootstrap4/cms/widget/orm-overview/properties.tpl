    ...
    <ul class="nav nav-tabs mb-2">
        <li class="nav-item">
            <a class="nav-link active" href="#query" data-toggle="tab">
                {translate key="title.query"}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#parameters" data-toggle="tab">
                {translate key="title.parameters.url"}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#mapper" data-toggle="tab">
                {translate key="title.content.mapper"}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#view" data-toggle="tab">
                {translate key="title.view"}
            </a>
        </li>
    </ul>
